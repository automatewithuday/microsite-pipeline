...
vi.mock("../db.js", () => ({ ADS_TRAFFIC_PROVIDER: "auto", DEEPLINE_API_KEY: "", APIFY_ACTOR_META_ADS: "test-meta-ads-actor", APIFY_TOKEN: "test-token" }));
...
describe("step 05 ads_meta", () => {
  ...
  it("missing = 0: no APIFY_TOKEN means count 0 without calling the actor", async () => {
    vi.resetModules();
    vi.doMock("../db.js", () => ({ ADS_TRAFFIC_PROVIDER: "auto", DEEPLINE_API_KEY: "", APIFY_ACTOR_META_ADS: "test-meta-ads-actor", APIFY_TOKEN: "" }));
